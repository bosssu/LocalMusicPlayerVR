...
public class AudioVisualizerDemo : MonoBehaviour {

    const string test1 = "/mnt/sdcard/Music/coop.mp3";
    const string test2 = "/storage/emulated/0/Music/coop.mp3";
    const string test3 = "/mnt/sdcard/Music/";
    const string test4 = "/storage/emulated/legacy/Music/";
    ...
    void Start()
    {
        ...
        DebugUIBuilder.instance.AddLabel(test1,1);
        DebugUIBuilder.instance.AddLabel(test2,1);
        DebugUIBuilder.instance.AddLabel(test3,1);
        DebugUIBuilder.instance.AddLabel(test4,1);
        DebugUIBuilder.instance.AddButton("加载test1", () => {
            StartCoroutine(LoadMusic(test1));
        },1);
        DebugUIBuilder.instance.AddButton("加载test2", () => {
            StartCoroutine(LoadMusic(test2));
        },1);
        DebugUIBuilder.instance.AddButton("加载test3", () => {
            StartCoroutine(LoadMusic(test3));
        },1);
        DebugUIBuilder.instance.AddButton("加载test4", () => {
            StartCoroutine(LoadMusic(test4));
        },1);
