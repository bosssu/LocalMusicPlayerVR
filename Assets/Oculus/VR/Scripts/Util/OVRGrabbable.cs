...
{
    [SerializeField]
    public bool m_shoud_active_kinematic = true;
    [SerializeField]
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        if(m_shoud_active_kinematic) gameObject.GetComponent<Rigidbody>().isKinematic = true;
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        if(m_shoud_active_kinematic) rb.isKinematic = m_grabbedKinematic;
