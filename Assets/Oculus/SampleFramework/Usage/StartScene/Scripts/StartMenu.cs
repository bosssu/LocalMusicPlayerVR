...
{   
    ...
    void Start()
    {
        ...
        DebugUIBuilder.instance.AddButton("Microphone test", LoadMicrophoneTest);
        DebugUIBuilder.instance.AddButton("AudioVisualizerDemo", ()=> { LoadScene("AudioVisualizerDemo"); });
    ...
    void LoadMicrophoneTest()
    {
        LoadScene("MicrophoneTest");
    }
